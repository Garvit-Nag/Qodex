        ...
        <div className="bg-white/90 dark:bg-white/5 backdrop-blur-md border border-gray-300 dark:border-white/20 rounded-2xl p-6 shadow-xl">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Link
                href="/about"
                className="bg-white/80 hover:bg-gray-100 dark:bg-white/10 dark:hover:bg-white/20 text-gray-900 dark:text-white border border-gray-300 dark:border-white/20 font-medium py-2 px-3 rounded-lg transition-colors flex items-center justify-center text-sm"
              >
                About
              </Link>
            </div>
