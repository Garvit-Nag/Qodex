    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto pointer-events-none">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pointer-events-auto">
          ...
          <button className="bg-gray-900 hover:bg-gray-800 dark:bg-gray-200 dark:hover:bg-gray-300 text-white dark:text-black font-medium py-3 px-8 rounded-full transition-all duration-300 hover:scale-105 shadow-lg border border-white/20 dark:border-gray-400/20">
            Get Started
          </button>
